...
print_info(
        IEEE754.converting_from_decimal_to_ieee754("0.000"),
        "0.000 в IEEE754",
        Verification.ieee754_to_decimal,
    )
print_info(
        IEEE754.converting_from_decimal_to_ieee754("1"),
        "1 в IEEE754",
        Verification.ieee754_to_decimal,
    )
print_info(
        IEEE754.converting_from_decimal_to_ieee754("1.0"),
        "1.0 в IEEE754",
        Verification.ieee754_to_decimal,
    )
print_info(
        IEEE754.converting_from_decimal_to_ieee754("1.00000"),
        "1.00000 в IEEE754",
        Verification.ieee754_to_decimal,
    )
print_info(
        IEEE754.converting_from_decimal_to_ieee754("1.1"),
        "1.1 в IEEE754",
        Verification.ieee754_to_decimal,
    )
print_info(
        IEEE754.converting_from_decimal_to_ieee754("1.10000"),
        "1.10000 в IEEE754",
        Verification.ieee754_to_decimal,
    )
print_info(
...
print_info(
        IEEE754.converting_from_decimal_to_ieee754("22.390625"),
        "22.390625 в IEEE754",
        Verification.ieee754_to_decimal,
    )